...
class GuestHousesPage extends React.Component {
    ...
    _renderAvailableRooms() {
        const AvailableRooms = this.props.apartments.map(apt => {
        ...
        return(
            <div role="tabpanel" className="tab-pane fade in active" id="select-room">
                <div className="mg-available-rooms">
                    <h2 className="mg-sec-left-title">Available Rooms</h2>
    ...
    _renderPersonalInfo() {
        return (
            <div role="tabpanel" className="tab-pane fade" id="personal-info">
                <div className="row">
    ...
    _renderPayment() {
        ...
        <input type="text" className="form-control"/>
            ...
            <a href="#thank-you" className="btn btn-dark-main btn-next-tab pull-right">Pay Now</a>
        <a href="#personal-info" className="btn btn-default btn-prev-tab pull-left">Back</a>
            </div>
            </div>
            <div className="col-md-4">
            <div className="mg-cart-container">
                    ...
                    <div className="row">
                        <div className="col-md-12">
                            ...
                            <div className="mg-booking-form">
                                {this._renderBookingStage()}

                                <div className="tab-content">
                                    <div role="tabpanel" className="tab-pane fade in active" id="select-room">
                                        {this._renderSearchRoom()}
