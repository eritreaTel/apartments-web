...
class BookingStage extends React.Component {
    render() {
        let {searching, personal, confirmation} = ApartmentHelper.getReservationStatuses(this.props.activeStage);
        ...
        return(
                <ul className="nav nav-tabs" role="tablist">
                    ...
                    <li role="presentation" className={personal}>
                        <Anchor className="inactiveLink" aria-controls="personal-info" role="tab" data-toggle="tab"><span className="mg-bs-tab-num">2</span><span className="mg-bs-bar"></span>Make Reservation</Anchor>
                    </li>

                    <li role="presentation" className={confirmation}>
                        <Anchor className="inactiveLink" aria-controls="thank-you" role="tab" data-toggle="tab"><span className="mg-bs-tab-num">3</span>Confirmation</Anchor>
                    </li>
                </ul>
            );
        }
